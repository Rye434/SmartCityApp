        ...
        return(
            <Content>
                <View style={Styles.cameraWarning.centerView}>
                    ...
                    <Button style={Styles.cameraWarning.buttonField} onPress={()=>this.props.navigation.navigate("CameraView")}><Text style={Styles.cameraWarning.buttonText}>{Strings.CAMERA_WARMING_BUTTON}</Text></Button>
                </View>
            </Content>
        )
    }
